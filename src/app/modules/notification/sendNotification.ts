        ...
        try {
          if (token) {
            const newNotification = await NotificationModel.create({
              fcmToken:
                "cPZOAkERS0qYrBKHEpnE-_:APA91bHi6Yz4hLQMlGyVMO1o2TrhslFxQy80pHCmjbyp4gQWEaqcyC_AzDU4oyXpoKc-AjC0YkcaS7W2pzbmxvldPmR_vQoaKohfJYl27hVcXjjYYB25YRXiL0b5FaVcwJuYlB_pzJ2u",
              title: payload.title,
